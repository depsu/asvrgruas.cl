...
(function () {
  ...
  window.PanelUI = {
    ...
    NOVEDADES: [
      ...
      { id: "2026-07-comentario-pago", vista: "pagos", el: "#adsComenta",
        titulo: "Comentario en tus pagos 💬",
        texto: "Al subir un comprobante ahora puedes dejarle un comentario. Útil cuando una sola transferencia cubre dos cosas — ej: «$100.000 de saldo y el resto adelanto del mes». Queda guardado junto al pago en tu historial." },
